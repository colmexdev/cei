...
function ajustarCuerpo(scroll){
  var ancho_act = Math.max(document.documentElement.clientWidth, window.innerWidth || document.body.ClientWidth || 0);
	...
	var alto_header;
	setTimeout(function(){
		alto_footer = (document.getElementById("div_footer") != null ? Math.min(document.getElementById('div_footer').clientHeight, 265) : 265);
		alto_header = (document.getElementById("header") != null ? Math.min(document.getElementById('header').clientHeight, 225) : 225);
