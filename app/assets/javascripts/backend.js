...
function extendTrix(ev){
  ...
  var textElement = toolbarElement.querySelector(".trix-button-group--text-tools");
	...
	textElement.insertAdjacentHTML("beforeend","<button type=\"button\" class=\"trix-button trix-button-icon\" data-trix-attribute=\"rosaLight\" data-trix-action=\"x-rosaLight\"  data-trix-key=\"l\" title=\"Rosa claro (Ctrl + l)\" tabindex=\"-1\"><div style=\"display:inline-block;background-color:#CC4E78;width:18px;height:20px;margin:5px auto 0;\"></div></button>");
